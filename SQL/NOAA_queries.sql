...
((v1+v2+v3+v4+v5+v6+v7+v8+v9+v10+v11+v12+v13+v14+v15+v16+v17+v18+v19+v20+v21+v22+v23+v24+v25+v26+v27+v28+v29+v30+v31)/31)/10 AS Month_AVG, StateAbbr, StateLong, CountryLong 
FROM obs
JOIN Stations USING(StationID)
JOIN States USING(StateAbbr)
JOIN Countries USING(CountryAbbr)
...
-- For non-null variables in v#, add together and average based on how many there are?  How to attempt this?
